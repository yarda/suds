...
from sudsds import *
from sudsds.sax import Namespace
from sudsds.sax.parser import Parser
from sudsds.sax.element import Element
from sudsds.sudsobject import Factory, Object
from sudsds.mx import Content
from sudsds.mx.literal import Literal as MxLiteral
from sudsds.umx.basic import Basic as UmxBasic
from sudsds.umx.typed import Typed as UmxTyped
from sudsds.bindings.multiref import MultiRef
from sudsds.xsd.query import TypeQuery, ElementQuery
from sudsds.xsd.sxbasic import Element as SchemaElement
...
class Binding:
    ...
    @ivar wsdl: The wsdl.
    @type wsdl: L{sudsds.wsdl.Definitions}
    ...
    @type parser: L{sudsds.sax.parser.Parser}
    """
    ...
    def replylist(self, rt, nodes):
        ...
        @type rt: L{sudsds.xsd.sxbase.SchemaObject}
    ...
    def replycomposite(self, rtypes, nodes):
        ...
        @type rtypes: [L{sudsds.xsd.sxbase.SchemaObject},...]
        @param nodes: A collection of XML nodes.
        @type nodes: [L{Element},...]
...
class PartElement(SchemaElement):
    ...
    @type resolved: L{sudsds.xsd.sxbase.SchemaObject}
    """
