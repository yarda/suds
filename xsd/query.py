...
from sudsds import *
from sudsds.sudsobject import *
from sudsds.xsd import qualify, isqref
from sudsds.xsd.sxbuiltin import Factory
...
class AttrQuery(Query):
    ...
    def __deepsearch(self, schema):
        from sudsds.xsd.sxbasic import Attribute
        result = None
        for e in schema.all:
...
class ElementQuery(Query):
    ...
    def __deepsearch(self, schema):
        from sudsds.xsd.sxbasic import Element
        result = None
        for e in schema.all:
