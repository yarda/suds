...
import sudsds
import sudsds.metrics as metrics
from cookielib import CookieJar
from sudsds import *
from sudsds.transport import TransportError, Request
from sudsds.transport.https import HttpAuthenticated
from sudsds.transport.cache import FileCache
from sudsds.servicedefinition import ServiceDefinition
from sudsds import sudsobject
from sudsobject import Factory as InstFactory
from sudsobject import Object
from sudsds.resolver import PathResolver
from sudsds.builder import Builder
from sudsds.wsdl import Definitions
from sudsds.sax.document import Document
from sudsds.sax.parser import Parser
...
class Client(object):
    ...
    def items(cls, sobject):
        """
        Extract the I{items} from a sudsds object much like the
        items() method works on I{dict}.
        @param sobject: A sudsds object
    ...
    def metadata(cls, sobject):
        """
        Extract the metadata from a sudsds object.
        @param sobject: A sudsds object
        @type sobject: L{Object}
    ...
    def __unicode__(self):
        s = ['\n']
        build = sudsds.__build__.split()
        s.append('Suds ( https://fedorahosted.org/sudsds/ )')
        s.append('  version: %s' % sudsds.__version__)
...
class SoapClient:
    ...
    def failed(self, binding, error):
        ...
        @param binding: The binding to be used to process the reply.
        @type binding: L{sudsds.bindings.binding.Binding}
