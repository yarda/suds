...
from sudsds import *
from sudsds.sax import splitPrefix
from sudsds.sax.parser import Parser
from sudsds.sax.element import Element
from sudsds.bindings.document import Document
from sudsds.bindings.rpc import RPC, Encoded
from sudsds.xsd import qualify, Namespace
from sudsds.xsd.schema import Schema, SchemaCollection
from sudsds.xsd.query import ElementQuery
from sudsds.sudsobject import Object
from sudsds.sudsobject import Factory as SFactory
...
class Part(NamedObject):
    ...
    @ivar element: The value of the {element} attribute.
        Stored as a I{qref} as converted by L{sudsds.xsd.qualify}.
    @type element: str
